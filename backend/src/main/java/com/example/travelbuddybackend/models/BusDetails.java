...
public class BusDetails {
    ...
    public BusDetails(Integer id, String busNumber, String busLine,
                      BusStation busDepartureStation, BusStation busArrivalStation,
                      String busDepartureDate, String busDepartureTime,
                      String busArrivalDate, String busArrivalTime,
